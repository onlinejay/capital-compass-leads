    ...
    <footer className="bg-gradient-to-b from-navy-800 to-navy-900 text-white">
      ...
      <div className="container mx-auto px-4 pb-16 pt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-16">
          ...
          <div>
            <div className="mb-6">
              <h3 className="text-2xl font-bold text-white">Capital<span className="text-primary">Compass</span></h3>
              <div className="h-1 w-12 bg-primary mt-3"></div>
            </div>
            <p className="text-white/80 mb-6 leading-relaxed">
              Private lending solutions that empower real estate investors. Fast funding for your investment opportunities.
            </p>
          ...
          {/* Loan Programs */}
          <div>
            <h3 className="text-lg font-bold mb-6">Loan Programs</h3>
            <ul className="space-y-3">
              <li>
                <a 
                  href="#programs" 
