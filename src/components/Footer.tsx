        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gold-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex">
                ...
                <a href="tel:+18005559000" className="text-white/90 hover:text-white transition-colors">(800) 555-9000</a>
              </li>
              <li className="flex">
                <Mail className="w-5 h-5 text-white/60 mr-3 flex-shrink-0" />
                <a href="mailto:loans@capitalcompass.com" className="text-white/90 hover:text-white transition-colors">loans@capitalcompass.com</a>
              </li>
            </ul>
          </div>
